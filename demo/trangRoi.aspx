<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="trangRoi.aspx.cs" Inherits="demo.trangRoi" %>
...
Với cương vị là chủ khách sạn Continental, Winston (Ian McShane thủ vai) đáng lẽ phải trừ khử kẻ phá luật nhưng vì tình bằng hữu giữa John và ông đã có từ lâu, Winston không nỡ thẳng tay giết hại bạn mình, thế nên ông đã dành tặng John một tiếng để bỏ chạy trước khi cuộc thanh trừng bắt đầu.</p>
        ...
        <div id="imgleft">
            <asp:Image ID="Image1" runat="server" ImageUrl="~/Themes/MOONFALL.jpg" CssClass="img"/>
        </div>
    </div>
    ...
    <div id="bigmain">
        ...
        <div id="main2">
            ...
            <asp:DropDownList ID="drMaphim" runat="server" CssClass="info" Enabled="False">
                <asp:ListItem Value="0" >102</asp:ListItem>
            </asp:DropDownList>
   ...
   <%-- <div id="main3">
        <asp:button id="btntimkiem" runat="server" text="tìm kiếm t.tin đặt vé" onclick="btnTimkiem_Click" />
    </div>
    <asp:textbox id="tbsdttimkiem" runat="server"></asp:textbox>
    <asp:gridview id="gridview1" runat="server" style="border:1px solid black;"></asp:gridview>--%>
